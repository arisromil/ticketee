...
describe TicketsController do
    ...
    context "standard users" do
      it "cannot access a ticket for a project" do
         ...
         flash[:notice].should eql("The project you were looking for could not be found.")
      end
      ...
      context "with permission to view the project" do
        ...
        def cannot_create_tickets!
          ...
          flash[:notice].should eql("You cannot create tickets on this project.")
        end

        def cannot_update_tickets!
           response.should redirect_to(project)
           flash[:notice].should eql("You cannot edit tickets on this project.")
        end
        ...
        it "cannot delete a ticket without permission" do
           ...
           response.should redirect_to(project)
           flash[:notice].should eql("You cannot delete tickets from this project.")
        end
